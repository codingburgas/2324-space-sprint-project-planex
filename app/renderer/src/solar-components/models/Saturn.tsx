...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null} position={[-240, 5, 0]} scale={[scaleValue, scaleValue, scaleValue]}>
      <group scale={0.00002}>
        ...
        <group rotation={[-1.551, -0.437, -0.663]}>
          <mesh geometry={nodes.Mimas_Mimas_0.geometry} material={materials.Mimas} position={[-80, 5, 0]} />
        </group>
        <group rotation={[-1.619, -0.156, 2.769]}>
          <mesh geometry={nodes.Enceladus_Enceladus_0.geometry} material={materials.Enceladus} position={[-80, 5, 0]} />
        </group>
      </group>
    </group>
  )
